...
const callChatAPI = async (message) => {
  ...
  try {
    ...
    if(message == "hai" || message == "Hai" || message == "hai!" || message == "Hai!" || message == "hai?" || message == "Hai?" || message == "hai" || message == "Hai"){
      return "Hai, saya AINA. Saya boleh membantu anda dengan apa yang anda perlukan.";
    }

    if(message == "hi" || message == "Hi" || message == "hi!" || message == "Hi!" || message == "hi?" || message == "Hi?" || message == "hi" || message == "Hi"){
      return "Hi, saya AINA. Saya boleh membantu anda dengan apa yang anda perlukan.";
    }
